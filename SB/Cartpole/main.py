...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        current_screen = get_screen()
        os.makedirs(f"Out/{i_episode}", exist_ok=True)
        if not done:
            next_state = current_screen - last_screen
            show_screen(title=f"Out/{i_episode}/wip_{t}")
        else:
            next_state = None
            show_screen(title=f"Out/{i_episode}/done_at_{t}")
